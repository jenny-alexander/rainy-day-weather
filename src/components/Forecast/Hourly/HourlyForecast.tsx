                                    ...
                                    return (
                                        <div className={styles.hourlyForecast} key={hour + '-' + index}>
                                            ...
                                            <div className={styles.hourlyImageContainer}>
                                                <img alt="Hourly weather" className={styles.hourlyImage} src={weatherIconImages.get(hour.weather[0].id)} />
                                            </div>
                                            ...
                                            <div className={styles.precipContainer}>
                                                <div className={styles.precipImageContainer}>
                                                    <img alt="raindrop depicting precipitation" className={styles.precipImage} src='/images/rain.png'></img>
                                                </div>
